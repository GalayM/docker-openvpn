...
# Allow UDP traffic on port 39022.
iptables -A INPUT -i eth0 -p udp -m state --state NEW,ESTABLISHED --dport 39022 -j ACCEPT
iptables -A OUTPUT -o eth0 -p udp -m state --state ESTABLISHED --sport 39022 -j ACCEPT
